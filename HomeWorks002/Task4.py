# Задача 4 НЕОБЯЗАТЕЛЬНАЯ. Напишите программу, которая принимает на вход N, и координаты двух точек и находит расстояние между 
...
def create_points (n):
    ...
    for i in range(2):
        points1 =[]
        for g in range(n):
            points1.append(float(input(f'Введите {g+1} координату, {i+1} точки: ')))
