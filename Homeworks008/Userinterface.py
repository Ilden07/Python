...
class Dictionary:
    def __init__(self, window):
        ...
        self.wind = window
        self.wind.title('База данных автомобилей')
        ...
        ttk.Label(frame_input, text='Объем двигателя').grid(row = 4, column=1)
        input_resol = ttk.Entry(frame_input)
        input_resol.grid(row = 4, column = 2)
        ttk.Label(frame_input, text='Кузов').grid(row = 5, column=1)
        ...
        heads = ['ID','Фирма','Модель','Объем двигателя','Кузов','Стоимость']
