...
def added_element (data):        
    sqlite_connection= sqlite3.connect('C:/Users/Артем/Desktop/Семинар ДЗ/Python/Seminars/Python/Homeworks008/auto.db', timeout=20)
    cursor = sqlite_connection.cursor()
...
def read_table ():
    all_data = []
    with sqlite3.connect('C:/Users/Артем/Desktop/Семинар ДЗ/Python/Seminars/Python/Homeworks008/auto.db') as db:
